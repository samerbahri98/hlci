...
RUN apt-get update && apt-get install --no-install-recommends -y software-properties-common=0.98.9.2 locale=2.31 && rm -rf /var/lib/apt/lists/* \
...
RUN pip install ansible=2.14 ansible-vault=2.9 yq=2.14.0
